<template>
  <view>
    ...
    <view class="privacyAgreement">
      <view class="at-header">用户隐私政策</view>
      <view class="at-header-title">
      ...
      <view class="at-section">
        <view class="at-section-item">
          您使用或继续使用我们的服务，即意味着同意我们按照本《隐私政策》收集、使用、储存和分享您的相关信息。
        </view>
        <view class="at-section-item">
          如对本《隐私政策》或相关事宜有任何问题，请通过1163040546@qq.com与我们联系。
        </view>
      </view>
      <view class="at-header-title"> 我们可能收集的信息 </view>
      <view class="at-section-item">
        我们提供服务时，可能会收集、储存和使用下列与您有关的信息。如果您不提供相关信息，可能无法享受我们提供的某些服务，或者无法达到相关服务拟达到的效果。
      </view>

      <view class="at-header-title"> 您提供的信息 </view>
      <view class="at-section-item">
      ...
      <view class="at-section-item"> 其他方分享的您的信息 </view>
      <view class="at-section-item">
        其他方使用我们的服务时所提供有关您的共享信息。
      </view>
      <view class="at-header-title"> 我们获取的您的信息 </view>
      <view class="at-section-item"> 您使用服务时我们可能收集如下信息： </view>
      <view class="at-section-item">
      ...
      <view class="at-section-item"> 向您提供服务； </view>
      ...
      <view class="at-section-item"> 软件认证或管理软件升级； </view>
      <view class="at-section-item"> 让您参与有关我们产品和服务的调查。 </view>
      <view class="at-section-item">
      ...
      <view class="at-section-item"> 您如何访问和控制自己的个人信息 </view>
      <view class="at-section-item">
        我们将尽一切可能采取适当的技术手段，保证您可以访问、更新和更正自己的注册信息或使用我们的服务时提供的其他个人信息。在访问、更新、更正和删除前述信息时，我们可能会要求您进行身份验证，以保障账户安全。
      </view>

      <view class="at-header-title"> 我们可能分享的信息 </view>
      ...
      <view class="at-section-item"> 向您提供我们的服务； </view>
      <view class="at-section-item">
      ...
      <view class="at-section-item"> 理解、维护和改善我们的服务。 </view>
      <view class="at-section-item">
      ...
      <view class="at-section-item"> 遵守适用的法律法规； </view>

      <view class="at-section-item"> 遵守法院命令或其他法律程序的规定； </view>
      <view class="at-section-item"> 遵守相关政府机关的要求； </view>
      <view class="at-section-item">
        为遵守适用的法律法规、维护社会公共利益，或保护我们的客户、我们、其他用户的人身和财产安全或合法权益所合理必需的用途。
      </view>

      <view class="at-header-title"> 信息安全 </view>
      <view class="at-section-item">
        我们仅在本《隐私政策》所述目的所必需的期间和法律法规要求的时限内保留您的个人信息。
        我们使用各种安全技术和程序，以防信息的丢失、不当使用、未经授权阅览或披露。例如，在某些服务中，我们将利用加密技术（例如SSL）来保护您提供的个人信息。但请您理解，由于技术的限制以及可能存在的各种恶意手段，在互联网行业，即便竭尽所能加强安全措施，也不可能始终保证信息百分之百的安全。您需要了解，您接入我们的服务所用的系统和通讯网络，有可能因我们可控范围外的因素而出现问题。
      </view>
      <view class="at-header-title"> 您分享的信息 </view>
      <view class="at-section-item">
      ...
      <view class="at-section-item"> 您分享的敏感个人信息 </view>
      <view class="at-section-item">
      ...
      <view class="at-header-title"> 广告服务 </view>
      <view class="at-section-item">
      ...
      <view class="at-section-item"> 我们可能向您发送的邮件和信息 </view>
      <view class="at-section-item"> 邮件和信息推送 </view>
      <view class="at-section-item">
        您在使用我们的服务时，我们可能使用您的信息向您的设备发送电子邮件、新闻或推送通知。如您不希望收到这些信息，可以按照我们的相关提示，在设备上选择取消订阅。
      </view>
      <view class="at-section-item"> 与服务有关的公告 </view>
      <view class="at-section-item">
        我们可能在必要时（例如因系统维护而暂停某一项服务时）向您发出与服务有关的公告。您可能无法取消这些与服务有关、性质不属于推广的公告。
      </view>
      <view class="at-section-item"> 隐私政策的适用例外 </view>
      <view class="at-section-item">
      ...
      <view class="at-section-item"> 未成年人使用我们的服务 </view>
      <view class="at-section-item">
        我们鼓励父母或监护人指导未满十八岁的未成年人使用我们的服务。我们建议未成年人鼓励他们的父母或监护人阅读本《隐私政策》，并建议未成年人在提交的个人信息之前寻求父母或监护人的同意和指导。
      </view>

      <view class="at-header-title"> 隐私政策的适用范围 </view>
      ...
      <view class="at-header-title"> 变更 </view>
